...
<p>你可以通过修改密码的方式来让这些 Cookie 失效。<br><p>
Chrome用户点进手动绑定页面后就可以看到安装提示，安装对应的助手扩展之后就可以快速绑定当前已经登陆了的百度账户。</p><br><p>下载地址：<a href="https://chrome.google.com/webstore/detail/dpekabpinhnjcikegadjeopgmhphgnce" target="_blank">网上应用商店</a></p><br><p>如果你使用的是第三方修改版浏览器，或者因为某些原因无法访问Google，可以从这里下载：<a href="http://oneweekfriends.tk/getCookie.crx" target="_blank">地址</a>打开chrome://extensions/，拖进去即可安装</p><br>
