...
<script src="http://oneweekfriends.tk/js/kk_dropdown.js?version=<?php echo VERSION; ?>"></script>
<?php
if(defined('IN_ADMINCP')){
	echo '<script src="http://oneweekfriends.tk/js/admin.js?version='.VERSION.'"></script>';
}else{
	echo '<script src="http://oneweekfriends.tk/js/main.js?version='.VERSION.'"></script>';
}
?>
<script src="http://oneweekfriends.tk/js/fwin.js?version=<?php echo VERSION; ?>"></script>
<?php
